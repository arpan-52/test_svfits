...
enum { TimeSize=sizeof(double), WtSize = 2*sizeof(float), 
       ...
       ActiveScans=64, DataFlagSize=ActiveScans*sizeof(int)} ;
...
typedef struct
{ int    macs, channels, pols, sta, cntrl, istatime,iabeam, pabeam1, pabeam2;
...
# define DAS_BUFSIZE 1090519040 // 1040 MB for GUP corr 32 ant, 4 stokes 4096 chan 4 buffs
